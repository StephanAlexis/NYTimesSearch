...
**NYTimesSerch** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
<img src='https://github.com/StephanAlexis/NYTimesSearch/blob/master/NYTimesSearch.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
## License
    ...
    Copyright [2018] [name of copyright Stephan]
